...
#define USB_UTMI_PHYCTRL_SUSPENDM (1 << 12)     /* Force PHY low power suspend(only for test) */
#define USB_UTMI_PHYCTRL_RESET (1 << 11)        /* Force reset of UTMI phy(only for test) */
...
#define USB_UTMI_PHYCTRL2_PLLDIV_MASK		(0x3 << USB_UTMI_PHYCTRL2_PLLDIV_SHIFT)
#define USB_UTMI_PHYCTRL2_PLLDIV_19_2_MHZ   (0x0 << USB_UTMI_PHYCTRL2_PLLDIV_SHIFT)
#define USB_UTMI_PHYCTRL2_PLLDIV_24_MHZ     (0x1 << USB_UTMI_PHYCTRL2_PLLDIV_SHIFT)
#define USB_UTMI_PHYCTRL2_PLLDIV_26_MHZ     (0x2 << USB_UTMI_PHYCTRL2_PLLDIV_SHIFT)
#define USB_UTMI_PHYCTRL2_PLLDIV_27_MHZ     (0x3 << USB_UTMI_PHYCTRL2_PLLDIV_SHIFT)

#define USB_UTMI_PHYCTRL2_CALBP             (1 << 7)

#define USB_UTMI_PHYCTRL2_PREEMP_DEPTH_SHIFT   8
#define USB_UTMI_PHYCTRL2_PREEMP_DEPTH_DEFAULT (0x0 << USB_UTMI_PHYCTRL2_PREEMP_DEPTH_SHIFT)
#define USB_UTMI_PHYCTRL2_PREEMP_DEPTH_PLUS_5  (0x1 << USB_UTMI_PHYCTRL2_PREEMP_DEPTH_SHIFT)
#define USB_UTMI_PHYCTRL2_PREEMP_DEPTH_PLUS_10 (0x2 << USB_UTMI_PHYCTRL2_PREEMP_DEPTH_SHIFT)
#define USB_UTMI_PHYCTRL2_PREEMP_DEPTH_PLUS_20 (0x3 << USB_UTMI_PHYCTRL2_PREEMP_DEPTH_SHIFT)

#define USB_UTMI_PHYCTRL2_LS_RISE_TIME_SHIFT   10
#define USB_UTMI_PHYCTRL2_LS_RISE_TIME_NORMAL  (0x2 << USB_UTMI_PHYCTRL2_LS_RISE_TIME_SHIFT)

#define USB_UTMI_PHYCTRL2_FS_RISE_TIME_SHIFT   12
#define USB_UTMI_PHYCTRL2_FS_RISE_TIME_NORMAL  (0x2 << USB_UTMI_PHYCTRL2_FS_RISE_TIME_SHIFT)

#define USB_UTMI_PHYCTRL2_CHARGE_PUMP_CURRENT_SHIFT 14
#define USB_UTMI_PHYCTRL2_CHARGE_PUMP_CURRENT_40_UA (0x0 << USB_UTMI_PHYCTRL2_CHARGE_PUMP_CURRENT_SHIFT)
#define USB_UTMI_PHYCTRL2_CHARGE_PUMP_CURRENT_20_UA  (0x1 << USB_UTMI_PHYCTRL2_CHARGE_PUMP_CURRENT_SHIFT)
